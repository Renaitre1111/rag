...
alchemy_with_h = {
    ...
    'n_nodes': {10: 1, 40: 1}, 
    'distances': [0] * 100,
    'colors_dic': ['#FFFFFF99', 'C7', 'C0', 'C3', 'C1', 'C5', 'C6', 'C2', 'C4', 'C8'],
    'radius_dic': [0.46, 0.77, 0.77, 0.77, 0.71, 1.0, 1.0, 0.99, 1.14, 1.33],
    'with_h': True,
    ...
    'bond1_stdv': {
        'H': 5, 'C': 2, 'N': 2, 'O': 2, 'F': 3,
        'P': 3, 'S': 3, 'Cl': 3, 'Br': 3, 'I': 3
    },
    
    'bond2_radius': {
        'H': -1000, 'C': 67, 'N': 60, 'O': 57, 'F': 59,
        'P': 96, 'S': 94, 'Cl': 90, 'Br': 110, 'I': 130 
    },

    'bond3_radius': {
        'H': -1000, 'C': 60, 'N': 54, 'O': 53, 'F': 53,
        'P': 88, 'S': 85, 'Cl': -1000, 'Br': -1000, 'I': -1000
    }
}
