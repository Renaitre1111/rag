...
def compute_qm9_smiles(dataset_name, remove_h):
    ...
    class StaticArgs:
        def __init__(self, dataset, remove_h):
            ...
            self.datadir = '/mnt/data/group/zhaoliangjie/raggeo-ldm/qm9/temp'
...
def retrieve_qm9_smiles(dataset_info):
    ...
    file_name = '/mnt/data/group/zhaoliangjie/raggeo-ldm/qm9/temp/%s_smiles.pickle' % pickle_name
    try:
        ...
        try:
            os.makedirs('/mnt/data/group/zhaoliangjie/raggeo-ldm/qm9/temp')
        except:
            pass
