...
def get_model(args):
    if args.model_name == 'egnn':
        ...
        model = SchNet(in_node_nf=5, hidden_nf=args.nf, device=args.device, 
...
if __name__ == "__main__":
    ...
    parser.add_argument('--exp_name', type=str, default='debug_schnet', metavar='N',
    ...
    parser.add_argument('--outf', type=str, default='outputs_schnet', metavar='N',
                        help='folder to output vae')
    parser.add_argument('--lr', type=float, default=1e-3, metavar='N',
                        help='learning rate')
    parser.add_argument('--nf', type=int, default=128, metavar='N',
                        help='hidden features (nf) for EGNN or SchNet')
    
    parser.add_argument('--attention', type=int, default=1, metavar='N',
                        help='attention in the egnn model')
    parser.add_argument('--n_layers', type=int, default=7, metavar='N',
                        help='number of layers for the EGNN')
    parser.add_argument('--node_attr', type=int, default=0, metavar='N',
                        help='node_attr or not')

    parser.add_argument('--n_interactions', type=int, default=6, metavar='N',
                        help='number of interaction blocks for SchNet')
    parser.add_argument('--n_gaussians', type=int, default=50, metavar='N',
                        help='number of gaussians for SchNet distance expansion')
    parser.add_argument('--cutoff', type=float, default=10.0, metavar='N',
                        help='cutoff radius for SchNet')
    ...
    parser.add_argument('--dataset', type=str, default="qm9_second_half", metavar='N',
                        help='qm9_second_half')
    ...
    parser.add_argument('--model_name', type=str, default='schnet', metavar='N',
                        help='egnn | schnet | naive | numnodes')
