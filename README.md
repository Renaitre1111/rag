...
```
```bash
python generate.py --run_name alpha --tokenizer_dir ./data/qm9_tokenizer/alpha --save_path cond/qm9/alpha_gens --target_prop_path data/qm9_alpha/sampled_alpha.txt --test_retrieval_path data/qm9_alpha/test_ret_alpha.npz --db_emb_path data/qm9_alpha/qm9_alpha_embeddings.npz --db_prop_path data/qm9_alpha/alpha.txt --temperature 0.7 --topk 80 --repeats 1 --batch_size 320 --ckpt_path cond/qm9/alpha_weights/finetune_qm9_step500.pt --max_len 128
